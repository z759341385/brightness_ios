...
class CameraModel: NSObject, ObservableObject, AVCapturePhotoCaptureDelegate {
    ...
    func setExposureAndISO(exposure: Float, iso: Float) {
        ...
        do {
            ...
            device.setFocusModeLocked(true, completionHandler: nil)
            device.setFocusModeLocked(false, completionHandler: nil)
            device.setExposureModeCustom(AVCaptureExposureModeCustom, duration: CMTimeMake(value: 1, timescale: 1000), iso: clampedISO, completionHandler: nil)
